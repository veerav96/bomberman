...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    if(f_7 in (0,1)):
        ...
        if(f_1==4 and f_2==0 and f_7==0):
            ...
            events.append(WAIT_GOOD)
        
        else:
            events.append(WAIT_BAD)
        
        if((f_7==1 and self_action=='BOMB')or (f_7==2 and self_action=='UP') or (f_7==3 and self_action=='RIGHT') or (f_7==4 and self_action=='DOWN')or (f_7==4 and self_action=='LEFT')):
            events.append(STRATEGY_GOOD)
        else:
            events.append(STRATEGY_BAD)
